...
const TablePaginationUnstyled = /*#__PURE__*/React.forwardRef(function TablePaginationUnstyled(props, ref) {
  ...
  const selectId = useId((_componentsProps$sele = componentsProps.select) == null ? void 0 : _componentsProps$sele.id);
  const labelId = useId((_componentsProps$sele2 = componentsProps.select) == null ? void 0 : _componentsProps$sele2['aria-labelledby']);
