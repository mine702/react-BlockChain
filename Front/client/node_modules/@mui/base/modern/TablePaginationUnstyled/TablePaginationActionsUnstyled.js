...
const TablePaginationActionsUnstyled = /*#__PURE__*/React.forwardRef(function TablePaginationActionsUnstyled(props, ref) {
  ...
  const firstButtonProps = appendOwnerState(FirstButton, _extends({
  ...
  const lastButtonProps = appendOwnerState(LastButton, _extends({
  ...
  const nextButtonProps = appendOwnerState(NextButton, _extends({
  ...
  const backButtonProps = appendOwnerState(BackButton, _extends({
