...
var TablePaginationActionsUnstyled = /*#__PURE__*/React.forwardRef(function TablePaginationActionsUnstyled(props, ref) {
  ...
  var firstButtonProps = appendOwnerState(FirstButton, _extends({
  ...
  var lastButtonProps = appendOwnerState(LastButton, _extends({
  ...
  var nextButtonProps = appendOwnerState(NextButton, _extends({
  ...
  var backButtonProps = appendOwnerState(BackButton, _extends({
