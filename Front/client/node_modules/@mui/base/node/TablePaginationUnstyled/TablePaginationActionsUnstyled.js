...
const TablePaginationActionsUnstyled = /*#__PURE__*/React.forwardRef(function TablePaginationActionsUnstyled(props, ref) {
  ...
  const rootProps = (0, _utils.appendOwnerState)(Root, (0, _extends2.default)({
    ref
  ...
  const firstButtonProps = (0, _utils.appendOwnerState)(FirstButton, (0, _extends2.default)({
    onClick: handleFirstPageButtonClick,
    disabled: page === 0,
    'aria-label': getItemAriaLabel('first', page),
    title: getItemAriaLabel('first', page)
  }, componentsProps.firstButton), ownerState);
  const LastButton = (_components$LastButto = components.LastButton) != null ? _components$LastButto : 'button';
  const lastButtonProps = (0, _utils.appendOwnerState)(LastButton, (0, _extends2.default)({
    onClick: handleLastPageButtonClick,
    disabled: page >= Math.ceil(count / rowsPerPage) - 1,
    'aria-label': getItemAriaLabel('last', page),
    title: getItemAriaLabel('last', page)
  }, componentsProps.lastButton), ownerState);
  const NextButton = (_components$NextButto = components.NextButton) != null ? _components$NextButto : 'button';
  const nextButtonProps = (0, _utils.appendOwnerState)(NextButton, (0, _extends2.default)({
    onClick: handleNextButtonClick,
    disabled: count !== -1 ? page >= Math.ceil(count / rowsPerPage) - 1 : false,
    'aria-label': getItemAriaLabel('next', page),
    title: getItemAriaLabel('next', page)
  }, componentsProps.nextButton), ownerState);
  const BackButton = (_components$BackButto = components.BackButton) != null ? _components$BackButto : 'button';
  const backButtonProps = (0, _utils.appendOwnerState)(BackButton, (0, _extends2.default)({
    onClick: handleBackButtonClick,
    disabled: page === 0,
    'aria-label': getItemAriaLabel('previous', page),
    title: getItemAriaLabel('previous', page)
  }, componentsProps.backButton), ownerState);
